// Item Descriptions for Settings Screen Tooltips

const POWERUP_DESCRIPTIONS = {
    scatter: "Fires multiple bullets in a cone pattern, great for close-range combat",
    laser: "High-speed beam that instantly hits targets with extended range",
    rocket: "Slow but powerful explosive projectile with area damage",
    explosive: "Bullets explode on impact, damaging nearby enemies",
    piercing: "Bullets pass through multiple targets without stopping",
    mine: "Deploys proximity mines that explode when enemies get close",
    drone: "Spawns autonomous combat drones that attack nearby enemies",
    homing: "Missiles that track and follow enemy tanks",
    flamethrower: "Short-range continuous flame that deals damage over time",
    freeze: "Freezes enemies in place temporarily, making them vulnerable",
...
if (typeof module !== 'undefined' && module.exports) {
    module.exports = { POWERUP_DESCRIPTIONS, HAZARD_DESCRIPTIONS };
}