...
function generateTerrainTiles() {
    ...
    const tileTypes = [
        { type: 'dirt', color: '#8B7D6B', weight: 30 },
        { type: 'sand', color: '#C4B5A0', weight: 20 },
        { type: 'mud', color: '#6B5D4F', weight: 15 },
        { type: 'gravel', color: '#9E9E9E', weight: 15 },
        { type: 'grass', color: '#7A8B5D', weight: 10 },
        { type: 'scorched', color: '#4A3C28', weight: 10 }
    ];
